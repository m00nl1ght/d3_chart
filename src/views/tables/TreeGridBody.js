  ...
  render() {
    ...
    function renderCell(row, rowIndex, column, columnIndex) {
      ...
      if (column.type === undefined || column.type === 'custom') {
        ...
        return this.table.$scopedSlots[column.template] ? this.table.$scopedSlots[column.template]({ row, rowIndex, column, columnIndex }) : ''
      }
      return ''
    }
          ...
          {this.table.bodyData.length > 0 ? (
            this.table.bodyData.map((row, rowIndex) => [
              ...
              this.table.expandType && row._isExpanded && (
                <tr key={rowIndex} class={`${this.prefixCls}__body-row ${this.prefixCls}--expand-row`}>
                  <td class={`${this.prefixCls}--expand-content`} colspan={this.table.tableColumns.length}>
            ...
            <tr class={`${this.prefixCls}--empty-row`}>
              <td class={`${this.prefixCls}__body-cell ${this.prefixCls}--empty-content`} colspan={this.table.tableColumns.length}>
